...
public class RoomNodeGraphEditor : EditorWindow
{
    ...
    private void CreateRoomNode(object mousePositionObject, RoomNodeTypeSO roomNodeType)
    {
        ...
        // GÁN roomNodeTypeList CHO NODE MỚI
        roomNode.roomNodeTypeList = currentRoomNodeGraph.roomNodeTypeList;
        // hoặc nếu bạn muốn chắc chắn:
        if (roomNode.roomNodeTypeList == null)
            roomNode.roomNodeTypeList = Resources.Load<RoomNodeTypeListSO>("RoomNodeTypeListSO");
